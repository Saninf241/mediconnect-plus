    ...
    <div className="space-y-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Lecture carte + empreinte + vérification droits.
            </p>
          </button>
          <button
            className={`${card} text-left hover:shadow-md`}
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Saisie manuelle contrat + empreinte + éligibilité.
            </p>
          </button>
          <button
            className={`${card} text-left hover:shadow-md`}
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Identité + (option) empreinte, pas d’éligibilité.
            </p>
          </button>
        </section>
      )}
                ...
                <div>
                  ...
                  {form.verification_level && (
                    <p className="text-xs text-gray-500 mt-1">
                      Niveau détecté : <b>{form.verification_level}</b>
                    </p>
                  )}
                </div>
                <div>
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        setMessage(
                          "Lecture carte : bientôt disponible (deeplink 'read_card' à brancher)."
                        );
                      } catch (e: any) {
      ...
      {step === 3 && (
        <section className={`${card} space-y-4`}>
          ...
          <p className="text-sm text-gray-600">
            Lance la capture d’empreinte sur la tablette. Si le matériel est
            indisponible, tu peux ignorer (le dossier sera marqué “empreinte
            manquante”).
          </p>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={async () => {
                try {
                  ...
                  setMessage(
                    "Capture lancée sur la tablette. Revenez ici après la lecture de l’empreinte."
                  );
                } catch (e: any) {
                  setMessage(
                    e.message ||
                      "Échec du lancement de la capture biométrique."
                  );
                } finally {
                  setLoading(false);
                }
            ...
            {form.biometrics?.status === "captured" && (
              <p className="text-sm text-green-700">
                Empreinte capturée ✅ — passe à l’étape suivante.
              </p>
            )}
